                ...
                <div className="inner">
                        ...
                        <div className="content">
                            ...
                            <div className="menu">
                                ...
                                <ul className="links">
                                    ...
                                    <li className="link"> <Link to="/residences"> Residences </Link> </li>
                                    <li className="link"> <Link to="/amenities"> Amenities </Link> </li>
                                    <li className="link"> <Link to="/availabilities"> Availabilities </Link> </li>
                                    <li className="link"> <Link to="/neighborhood"> Neighborhood </Link> </li>
                    ...
                    <div className="lower-wrap">
                        ...
                        <ul className="extra-links">
                            <li className="link"> <p > Fair Housing Statement </p> </li>
                            <li className="link"> <p > Accessibility </p> </li>
                        </ul>
                    </div>
                </div>
            </footer>
